...
import io.github.palexdev.materialfx.demo.services.SessionService;
...
public class AdminHomeController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        //this.contentLabel.setText("welcome " + UserSession.getInstance().getCurrentUser().getFirstname());
    }
