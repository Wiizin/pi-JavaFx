...
public class SignUpController {
    ...
    private boolean validateFields() {
        ...
        boolean allFieldsEmpty = firstNameField.getText().trim().isEmpty() &&
        ...
        if (allFieldsEmpty) {
            ...
            return false;  // Return immediately after showing the alert for empty fields
        }

        // Only proceed with individual validations if at least one field is filled
        boolean isValid = true;

        // Check for partially filled form
        if (!allFieldsEmpty) {
