...
//                .get());
            ...
            loader.addView(MFXLoaderBean.of("Tournois", loadURL("fxml/Tournois.fxml"))
                    .setBeanToNodeMapper(() -> createToggle("fas-trophy", "Tournois"))
                    .setDefaultRoot(false)
                    .get());
            loader.addView(MFXLoaderBean.of("Match", loadURL("fxml/MatchsDetails.fxml"))
                    .setBeanToNodeMapper(() -> createToggle("fas-circle-dot", "Match"))
                    .setDefaultRoot(false)
                    .get());
